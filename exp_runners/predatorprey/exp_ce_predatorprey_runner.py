...
def run(args):
    ...
    wandb.init(project="exp_ce_predatorprey", entity="lxxxxr", config=args)
    ...
    if args.mode == "train":
        ...
        def train_predatorprey(ctxt=None, args_dict=vars(args)):
            ...
            hidden_nonlinearity = (
                F.relu if args.hidden_nonlinearity == "relu" else torch.tanh
            )
            ...
            algo = CentralizedMAPPO(
                ...
                stop_entropy_gradient=True if args.entropy_method == "max" else False,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--attention_type", type=str, default="hard_soft")
